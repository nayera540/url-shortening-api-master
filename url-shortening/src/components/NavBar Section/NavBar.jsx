...
function NavBar() {
    return (
        <div className="navbar-section pt-9 w-full">
            <div className="container mx-auto">
                <div className="nav-wrapper flex flex-wrap items-center justify-between">
                    <div className="navheader flex items-center flex-shrink-0 mr-6">
                        <a href="">
                    ...
                    <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                        <div className="navlinks lg:flex-grow">
                            <ul className="links-list flex flex-row items-center gap-5">
